...
export const config = {
	...
	/**
	 * Whether to use fake/mock data for profiling service
	 */
	fakeProfiling: getEnvBoolean('FAKE_PROFILING', false),
	...
	/**
	 * Whether to use fake/mock data for paying service
	 */
	fakePaying: getEnvBoolean('FAKE_PAYING', false),
...
export const profilingConfig = {
	baseUrl: getEnv('PROFILING_URL') || `${config.apiBaseUrl}/profiling`,
	useFakeData: config.fakeProfiling
} as const;
...
/**
 * Paying service configuration
 */
export const payingConfig = {
	baseUrl: getEnv('PAYING_URL') || `${config.apiBaseUrl}/paying`,
	useFakeData: config.fakePaying
} as const;
